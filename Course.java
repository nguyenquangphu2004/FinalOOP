...
public class Course {
    ...
    private ArrayList<GradeOfStudent> gradeOfStudents = new ArrayList<>();
    ...
    public GradeOfStudent gradeOfStudentInCourse(Student student, Grade grade) {
        return new GradeOfStudent(student,grade);
    }
    ...
    public class GradeOfStudent {
        ...
        public String toStringGradeOfStudent() {
            return student.getIdStudent() + ";" + student.getFullName() + ";" + student.getBirth() + ";" +
                    grade.getAttendGrade() + ";" + grade.getMidtermScoreI() + ";" + grade.getSemesterEndGradeI() + ";"
                    +grade.getAvGradeI() + ";" + grade.getMidtermScoreII() + ";" + grade.getSemesterEndGradeII() + ";" +
                    grade.getAvGradeII() + ";" + grade.getAvGrade() + ";" + getIdCourse() + ";" + grade.getIdGrade();
        }
    }
