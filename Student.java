...
public class Student extends Person{
    ...
    public int compareTo(Person o) {
        int last = getFullName().lastIndexOf(" ");
        String name = getFullName().substring(last + 1);
        int last1 = o.getFullName().lastIndexOf(" ");
        String name1 = o.getFullName().substring(last + 1);
